...
var Car = /*#__PURE__*/function (_Vehicle) {
  function Car(make, model) {
    ...
    return _callSuper(this, Car, [make, model, 4]);
  }
  _inherits(Car, _Vehicle);
  return _createClass(Car);
}(Vehicle);
var MotorCycle = /*#__PURE__*/function (_Vehicle2) {
...
// --- NCycle Class
var NCycle = /*#__PURE__*/function () {
  function NCycle(make, model, wheels) {
    _classCallCheck(this, NCycle);
    this.status = "stopped";
    this.make = make;
    this.model = model;
    this.wheels = wheels;
  }
  return _createClass(NCycle, [{
    key: "start",
    value: function start() {
      this.status = "started";
    }
